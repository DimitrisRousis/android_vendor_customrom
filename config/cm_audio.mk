...
ALARM_PATH := vendor/customrom/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/customrom/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/customrom/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/customrom/prebuilt/common/media/audio/ui
